...
Teams can block individual contacts to manage unwanted interactions or prevent abuse. Blocking a contact is a single-click action available directly from the contact's profile.
...
Contacts can be unblocked at any time from their profile. Once unblocked, normal agent interactions resume immediately across all channels.
