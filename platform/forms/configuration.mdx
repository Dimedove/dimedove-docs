...
Choose which agent tools are available in this form.

- By default, all agent tools are available
- Enable override to select specific tools only
- Only active tools can be selected
