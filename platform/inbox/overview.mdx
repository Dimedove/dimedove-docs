...
- **View conversations across all channels** – Access web chats, calls, SMS, forms, emails, Slack and Microsoft Teams threads, social messages, and app conversations in a unified interface.
...
- **Access conversation history** – Conversations are ordered by last activity, with timestamps rendered as “time ago” to quickly judge recency; infinite scroll loads older threads.
...
- **Track conversation metadata** – Sidebar pills show conversation type, associated agent, contact, and applied labels for quick triage.
...
- **Web** - Messenger widget conversations on your website
...
- **Email** - Conversations on your email channels
- **Slack** and **Teams** - Threads with your agents in Slack and [Microsoft Teams](/platform/workspace/overview), grouped as **Workspace** in the filters
- **Messenger**, **Instagram**, and **TikTok** - Direct messages on your [social channels](/platform/socials/overview)
- **App** - Conversations started through the [Apps API](/developer/apps/overview)
