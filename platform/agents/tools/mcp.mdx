...
MCP (Model Context Protocol) tools allow your agent to connect to external MCP servers and use the tools they provide during conversations. This opens up powerful integrations with third-party services, custom APIs, and specialized functionality that extend your agent's capabilities.

<Info>
MCP tools require a Pro plan subscription.
</Info>
