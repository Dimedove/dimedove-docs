...
- **Point to what the agent already has**: a procedure can tell your agent which tool to use or what information to collect first, for example "check availability and offer the next three open slots before proposing a call".
