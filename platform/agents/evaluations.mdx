---
title: Evaluations
description: Test your agent's performance with automated scenarios and independent scoring
---
...
Evaluations run against your agent's current configuration (including the published version, instructions, knowledge base, and tools). They do not affect your inbox, contacts, or production conversations.
