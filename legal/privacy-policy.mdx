...
Business Customers using Dimedove Apps are the data controllers for personal information collected through their applications. Dimedove processes this data on behalf of the Business Customer in its capacity as a data processor.
...
For additional details about data export and portability, please refer to the Data Portability and Export section of our [Terms of Service](https://docs.dimedove.com/legal/terms-of-service).
